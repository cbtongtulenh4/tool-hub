...
class DownloadItemWidget(QFrame):
    ...
    def _build_ui(self):
        ...
        self.titleLbl.setWordWrap(True)

        metaRow = QHBoxLayout()
        metaRow.setSpacing(8)
        metaRow.setAlignment(Qt.AlignLeft | Qt.AlignVCenter)
        ...
        # Không ép min width để layout tự giãn
...
class DownloadsPage(QWidget):
    def __init__(self):
        ...
        self.list.setSpacing(2)  # giảm khoảng cách giữa các item
    ...
    def addDownloadItem(self, widget: DownloadItemWidget):
        ITEM_PAD, THUMB_H = 14, 90
        item_h = THUMB_H + ITEM_PAD * 2  # = 118px, khớp nội dung
